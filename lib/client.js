...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    console.log("✅ PRAVEEN MD Login Successful!");
                    console.log("⬇️  PRAVEEN MD Installing External Plugins...");
                    ...
                    for (let i = 0; i < check.length; i++) {
                     ...
                     console.log("✅  PRAVEEN MD External Plugins Installed!");fs.readdirSync(__dirname + "/../commands").forEach((plugin) => {
...
╟ ♤ 𝚃𝙷𝙰𝙽𝙺𝚂 𝙵𝙾𝚁 𝚄𝚂𝙴𝙸𝙽𝙶 PRAVEEN MD

╟ ♤ 𝙳𝙴𝚅𝙰𝙻𝙾𝙿𝙴𝚁 𝙱𝚈 PRAVEEN NIMSARA 
